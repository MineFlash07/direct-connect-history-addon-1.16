...
public class HistoryServerListScreen extends Screen {
    ...
    private final LabyModMultiplayerScreen manipulatedCallback;
    ...
    protected HistoryServerListScreen(ModGuiMultiplayer screenBefore, DirectConnectHistoryAddon addon) {
        ...
        this.manipulatedCallback = (LabyModMultiplayerScreen) this.screenBefore;
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        this.manipulatedCallback.directConnectToServer(true);
        return true;
    }
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, toSmall ? 195 : this.height / 4 + 96 + 12, 200, 20
                , ITextComponent.getTextComponentOrEmpty(I18n.format("selectServer.select", new Object[0])), press -> this.manipulatedCallback.directConnectToServer(true)));
        this.addButton(new Button(this.width / 2 - 100, toSmall ? 216 : this.height / 4 + 120 + 12, 200, 20
                , ITextComponent.getTextComponentOrEmpty(I18n.format("gui.cancel", new Object[0])), press -> this.manipulatedCallback.directConnectToServer(false)));
        ...
        this.addButton(new Button(this.width / 2 - 100, 190 - (toSmall ? 19 : 0), 100, 20, ITextComponent.getTextComponentOrEmpty("Paste")
                , press -> this.textField.setText(this.lastServerDropdown.getSelected())));
